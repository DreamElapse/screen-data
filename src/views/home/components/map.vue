...
.mapcont {
  ...
  height: 100%;
  position: relative;
  // background: url(https://img.gaolvzongheng.com/img-static/11.3017f1de88993fa9.png) no-repeat center center;
  ...
  .map2 {
    ...
    height: 100%;
    // background: url(https://img.gaolvzongheng.com/img-static/11.3017f1de88993fa9.png) no-repeat center center;
    background: url(https://img.gaolvzongheng.com/img-static/map.964a1c3f006de5e0.png) no-repeat center center;
    background-size: contain;
